...
public class ImportDataWKPanel extends AbstractWorkPanel implements ActionListener {
	...
	public void initialize() {
		...
		listPanel.addBatchBillListButton(new WLTButton[]{importAll,importOne,importDay});
