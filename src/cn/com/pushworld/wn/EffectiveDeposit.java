 ...
 * 有效存款户数保存
 */
public class EffectiveDeposit {
	public String impCkYxHsTj(String usercount){
		String countsb=new String();
		CommDMO dmo = new CommDMO();
		String [] str=usercount.split(";");
		InsertSQLBuilder insert=new InsertSQLBuilder("WN_CKYXHSTJ");
		try {
			String id=dmo.getSequenceNextValByDS(null,"S_WN_CKYXHSTJ");
			HashVO [] vo=dmo.getHashVoArrayByDS(null,"select * from pub_user where code='"+str[0].toString()+"'");
